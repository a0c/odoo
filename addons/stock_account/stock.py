...
class stock_move(osv.osv):
    ...
    def _get_account_invoice(self, inv_type, context):
        if inv_type in ('out_invoice', 'out_refund'):
            ...
            if not account_id:
                account_id = self.product_id.categ_id.property_account_expense_categ.id
        return account_id
    ...
    def _get_invoice_line_vals(self, cr, uid, move, partner, inv_type, context=None):
        ...
        name = False
        account_id = move._get_account_invoice(inv_type, context)
        if inv_type in ('out_invoice', 'out_refund'):
